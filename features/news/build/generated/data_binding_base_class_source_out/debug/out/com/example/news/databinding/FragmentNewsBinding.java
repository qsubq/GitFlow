...
public final class FragmentNewsBinding implements ViewBinding {
  ...
  private FragmentNewsBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull AppCompatImageView imgToolbar, @NonNull Toolbar mainToolbar,
  ...
  public static FragmentNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.img_toolbar;
      AppCompatImageView imgToolbar = ViewBindings.findChildViewById(rootView, id);
      if (imgToolbar == null) {
        break missingId;
      }
      ...
      return new FragmentNewsBinding((LinearLayoutCompat) rootView, imgToolbar, mainToolbar,
          progressBar, rvNews);
    }
