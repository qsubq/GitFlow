package com.example.javacoretraining.app.presentation.screen.auth
...
import com.example.javacoretraining.databinding.FragmentAuthBinding
...
class AuthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSignIn.setOnClickListener {
            this.findNavController().navigate(R.id.action_authFragment_to_containerFragment)
        }
        spannableText()
        eTObservable()
    }
